"""
Django settings for sitePjt project.
...
SECRET_KEY = '-+%h(v5j(6(xppf8v4(z3l_@&ue0fj^t_z^7=k#v6p=$mx#s!-'
...
WSGI_APPLICATION = 'sitePjt.wsgi.application'
