    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contentType', models.CharField(choices=[('text/plain', 'Plain text'), ('text/markdown', 'Markdown'), ('application/base64', 'Application'), ('image/jpeg;base64', 'Image/jpeg'), ('image/png;base64', 'Image/png')], default='text/plain', max_length=20)),
