    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contentType', models.CharField(choices=[('app', 'application/base64'), ('text', 'text/plain'), ('jpeg', 'image/jpeg;base64'), ('png', 'image/png;base64'), ('md', 'text/markdown')], default='text', max_length=4)),
